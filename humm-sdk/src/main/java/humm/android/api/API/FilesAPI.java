...
public class FilesAPI extends HummAPI {
    ...
    public static int MODE_CHANNEL = 1;
    public static int MODE_DM = 2;
...
//            result.setError_response("sync error");
    ...
    public void uploadDMFile(final String userId, final String file, final OnActionFinishedListener listener) {
        new HummTask<ChatResult<Message>>(new HummTask.Job() {
            @Override
            public Object onStart() throws Exception {
                return uploadDMFile(userId, file);
            }
    ...
    public ChatResult<Message> uploadDMFile(final String userId, final String file) {
        ...
        try {
            ...
            URL url = new URL(endpoint + "/files/direct/send?uid=" + userId);
...
//            result.setError_response("sync error");
     ...
     * @throws IOException
     */
    public static void downloadFile(String idRoom, String fileURL, String saveDir, int mode)
            throws IOException {
        ...
        if (responseCode == HttpURLConnection.HTTP_OK) {
            ...
            if (mode == MODE_CHANNEL) {
                ...
                HummAPI.getInstance().getFilesAPI().uploadDMFile(idRoom, Uri.parse((saveFilePath)).toString(), new OnActionFinishedListener() {
                    @Override
                    public void actionFinished(Object result) {
