...
//            result.setError_response("sync error");
    ...
    public void tracksFromDirectMessage(final String userId, final OnActionFinishedListener listener) {
        new HummTask<MessageMultipleResult<Message>>(new HummTask.Job() {
            @Override
            public Object onStart() throws Exception {
                return tracksFromDirectMessage(userId);
            }
    ...
    public MessageMultipleResult<Message> tracksFromDirectMessage(String userId) {
...
//            HummAPI.getInstance().updateUserToken();
            ...
            Reader reader = HttpURLConnectionHelper.getHttpConnection(endpoint + "/messages/direct/" + userId + "/tracks", null, token, true);
