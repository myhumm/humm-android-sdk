...
public class PlaylistsAPI extends HummAPI {
    ...
    public HummSingleResult<PlaylistOwnerHashMap> get(String idPlaylist) {
        ...
        try {
            ...
            Reader reader = HttpURLConnectionHelper.getHttpConnection(endpoint + "/playlists/" + idPlaylist, null, token, DEBUG);
    ...
    public HummSingleResult<PlaylistOwnerHashMap> create(final String title, final String description, final boolean isPrivate) {
        ...
        try {
            ...
            Reader reader = HttpURLConnectionHelper.postHttpConnection(endpoint + "/playlists", parameters, true, token, DEBUG);
            result = new Gson().fromJson(reader, listType);
    ...
    public HummSingleResult<PlaylistOwnerHashMap> delete(final String idPlaylist) {
        ...
        try {
            ...
            Reader reader = HttpURLConnectionHelper.deleteHttpConnection(endpoint + "/playlists/" + idPlaylist, parameters, token, DEBUG);
            result = new Gson().fromJson(reader, listType);
    ...
    public HummMultipleResult<PlaylistOwnerHashMap> getFeatured(final int limit, final int offset) {
        ...
        try {
            ...
            Reader reader = HttpURLConnectionHelper.getHttpConnection(endpoint + "/playlists/featured", parameters, token, DEBUG);
            result = new Gson().fromJson(reader, listType);
    ...
    public HummSingleResult<PlaylistOwnerHashMap> update(String idPlaylist, String title, String description, boolean isPrivate) {
        ...
        try {
            ...
            Reader reader = HttpURLConnectionHelper.patchHttpConnection(endpoint + "/playlists/" + idPlaylist, parameters, true, token, DEBUG);
            result = new Gson().fromJson(reader, listType);
    ...
    public HummMultipleResult<Song> order(final String idPlaylist, final List<HashMap<String, String>> order) {
        ...
        try {
            ...
            Reader reader = HttpURLConnectionHelper.patchHttpConnection(endpoint + "/playlists/" + idPlaylist + "/reorder", parameters, false, token, DEBUG);
//            result = new Gson().fromJson(reader, listType);
    ...
    public HummMultipleResult<Song> getSongs(final String idPlaylist, final int limit, final int offset) {
        ...
        try {
            ...
            Reader reader = HttpURLConnectionHelper.getHttpConnection(endpoint + "/playlists/" + idPlaylist + "/songs", parameters, token, DEBUG);
//            result = new Gson().fromJson(reader, listType);
    ...
    public HummSingleResult<PlaylistOwnerHashMap> addSong(final String idPlaylist, final String idSong, final int position) {
        ...
        try {
            ...
            Reader reader = HttpURLConnectionHelper.postHttpConnection(endpoint + "/playlists/" + idPlaylist + "/songs", parameters, true, token, DEBUG);
            result = new Gson().fromJson(reader, listType);
    ...
    public HummSingleResult<PlaylistOwnerHashMap> deleteSong(final String idPlaylist, final String idSong) {
        ...
        try {
            ...
            Reader reader = HttpURLConnectionHelper.deleteHttpConnection(endpoint + "/playlists/" + idPlaylist + "/songs", parameters, token, DEBUG);
            result = new Gson().fromJson(reader, listType);
    ...
    public HummSingleResult<PlaylistOwnerList> addSubscriber(final String idPlaylist) {
        ...
        try {
            ...
            Reader reader = HttpURLConnectionHelper.postHttpConnection(endpoint + "/playlists/" + idPlaylist + "/subscribers", null, true, token, DEBUG);
            result = new Gson().fromJson(reader, listType);
    ...
    public HummSingleResult<PlaylistOwnerList> removeSubscriber(final String idPlaylist) {
        ...
        try {
            ...
            Reader reader = HttpURLConnectionHelper.deleteHttpConnection(endpoint + "/playlists/" + idPlaylist + "/subscribers", null, token, DEBUG);
            result = new Gson().fromJson(reader, listType);
    ...
    public HummMultipleResult<PlaylistOwnerList> getPopular(final int limit, final int offset, final int section, final String idUser) {
        ...
        try {
            ...
            Reader reader = HttpURLConnectionHelper.getHttpConnection(endpoint + "/playlists/popular", parameters, token, DEBUG);
            result = new Gson().fromJson(reader, listType);
     ...
     *                 Is guaranteed that is called in main thread, so is safe call UI elements inside it.
     */
    public void getStaffPicks(final int limit, final int offset, final OnActionFinishedListener listener) {
        new HummTask<HummMultipleResult<PlaylistOwnerList>>(new HummTask.Job() {
            @Override
            public Object onStart() throws Exception {
                return getStaffPicks(limit, offset);
            }
    ...
    /**
     * Get a list of playlists staffpicks on Humm; returns a list of playlist objects (for an optional selection or user id)
     *
     * @param limit   Number of returned results (20 by default)
     * @param offset  Offset results by said number (0 by default)
     */
    public HummMultipleResult<PlaylistOwnerList> getStaffPicks(final int limit, final int offset) {
        ...
        try {
            ...
            Reader reader = HttpURLConnectionHelper.getHttpConnection(endpoint + "/playlists/staffpicks", parameters, token, DEBUG);
            result = new Gson().fromJson(reader, listType);
    ...
    public HummMultipleResult<PlaylistOwnerList> getRecent(final int limit, final int offset) {
        ...
        try {
            ...
            Reader reader = HttpURLConnectionHelper.getHttpConnection(endpoint + "/playlists/recent", parameters, token, DEBUG);
            result = new Gson().fromJson(reader, listType);
    ...
    public HummMultipleResult<PlaylistOwnerList> search(final String keyword, final int limit, final int offset, final int album) {
        ...
        try {
            ...
            Reader reader = HttpURLConnectionHelper.getHttpConnection(endpoint + "/playlists", parameters, token, DEBUG);
            result = new Gson().fromJson(reader, listType);
